"""
The Manic AI company chart. Each key is an agent. `reports` lists its direct
reports — that's what turns this from a flat pipeline into a real hierarchy:
a manager delegates to its reports, reviews what comes back, can send work
back for a fix, and only then reports its own result up to *its* manager.
...
coding team, who can look up real docs/APIs before writing code, not just
...
GitHub tokens are looked up (scoped to user + organization, never just
user). The same chart runs identically whether it's working on DigiMarkIn,
LFS Loans, BrightEduAid, Nappilos, or KwikNap — it just never sees more than
the one organization it was invoked for.
"""
...
ORG_CHART = {
    "ceo": {
        ...
        "team": "executive",
        "reports": ["coding_head", "marketing_head", "growth_head", "accounting_head", "sales_head", "operations_head"],
        "sequential": False,
        "system": (
    ...
    "coding_head": {
        ...
        "team": "coding",
        "reports": ["frontend_dev", "backend_dev", "bug_checker_frontend", "bug_checker_backend", "integration_checker"],
        "sequential": True,
        "uses_git": True,
        "system": (
    ...
    "frontend_dev": {
        "label": "Frontend Developer", "team": "coding", "reports": [], "uses_git": True, "uses_browse": True,
        "system": (
    ...
    "backend_dev": {
        "label": "Backend Developer", "team": "coding", "reports": [], "uses_git": True, "uses_browse": True,
        "system": (
    ...
    "bug_checker_frontend": {
        "label": "Frontend Bug Checker", "team": "coding", "reports": [], "uses_git": True, "uses_browse": True,
        "system": (
    ...
    "bug_checker_backend": {
        "label": "Backend Bug Checker", "team": "coding", "reports": [], "uses_git": True, "uses_browse": True,
        "system": (
    ...
    "integration_checker": {
        "label": "Integration Checker", "team": "coding", "reports": [], "uses_git": False, "uses_browse": True,
        "system": (
    ...
    "marketing_head": {
        "label": "Manic Marketing — Manager", "team": "marketing",
        "reports": ["traditional_marketing", "digital_marketing"], "sequential": False,
        "system": (
    ...
    "traditional_marketing": {
        "label": "Traditional Marketing", "team": "marketing", "reports": [], "uses_browse": True,
        "system": (
    ...
    "digital_marketing": {
        "label": "Digital Marketing", "team": "marketing", "reports": [], "uses_browse": True,
        "system": (
    ...
    # ---------------- Manic Growth ----------------
    "growth_head": {
        "label": "Manic Growth — Manager", "team": "growth",
        "reports": ["market_researcher", "business_analyst"], "sequential": False,
        "system": (
    ...
    "market_researcher": {
        "label": "Market Researcher", "team": "growth", "reports": [], "uses_browse": True,
        "system": (
    ...
    "business_analyst": {
        "label": "Business Analyst", "team": "growth", "reports": [], "uses_browse": True,
        "system": (
    ...
    # ---------------- Manic Accounting ----------------
    "accounting_head": {
        "label": "Manic Accounting — Manager", "team": "accounting",
        "reports": ["bookkeeper"], "sequential": False,
        "system": (
    ...
    "bookkeeper": {
        "label": "Bookkeeper", "team": "accounting", "reports": [], "uses_browse": True,
        "system": (
    ...
    # ---------------- Manic Sales ----------------
    "sales_head": {
        "label": "Manic Sales — Manager", "team": "sales",
        "reports": ["sales_rep"], "sequential": False,
        "system": (
    ...
    "sales_rep": {
        "label": "Sales Rep", "team": "sales", "reports": [], "uses_browse": True,
        "system": (
    ...
    # ---------------- Manic Operations ----------------
    "operations_head": {
        "label": "Manic Operations — Manager", "team": "operations",
        "reports": ["ops_coordinator"], "sequential": False,
        "system": (
    ...
    "ops_coordinator": {
        "label": "Ops Coordinator", "team": "operations", "reports": [], "uses_browse": True,
        "system": (
